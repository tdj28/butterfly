...
The latest homoclinic figure follows all twenty-one qualified curve points to
within $1.75\times10^{-5}$ in $a$ of the historical section, resolves the
first local $a$ minimum and conditioned outgoing branch at nanoscopic scale,
and displays prospective gate failures separately from the accepted branch.
