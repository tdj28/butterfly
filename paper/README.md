...
The latest homoclinic figure follows all thirteen qualified curve points to
within $1.75\times10^{-5}$ in $a$ of the historical section, resolves the
local $c$ fold at nanoscopic scale, and displays prospective gate failures
separately from the accepted branch.
