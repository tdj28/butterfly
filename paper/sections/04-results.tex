...
Two event locations were predicted from earlier rungs before their dedicated
refinement.  The frozen period-80 to period-160 prediction missed the resolved
event by $1.398\times10^{-7}$.  The frozen period-320 to period-640 prediction
missed by $3.00\times10^{-10}$.  The next period-640 to period-1280 prediction
is frozen at $b=0.1797121964470$ but has not yet passed the event and child
qualification gates.
