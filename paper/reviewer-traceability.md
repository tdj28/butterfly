...
| Two/three extrema oscillation was promising but insufficiently demonstrated | `jones2012topological`, `barrio2012topological` | Results; “Topology and symbolic tests still required” | RVR-003 | Local controls and one held-out saddle pass; EXP-117 narrows the bracket; EXP-118 diagnoses the old adjacent two label as coarse-resolution dependent, but `a=0.145` support and prospective resolution convergence remain open |
