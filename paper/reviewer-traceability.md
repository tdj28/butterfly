...
| Two/three extrema oscillation was promising but insufficiently demonstrated | `jones2012topological`, `barrio2012topological` | Results; “Topology and symbolic tests still required” | RVR-003 | Local controls and one held-out saddle cell pass; EXP-117 narrows the saddle bracket but exposes unresolved support at `a=0.145` and an adjacent `0.149/0.150` identity question; continued curve open |
