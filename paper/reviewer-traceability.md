...
| Two/three extrema oscillation was promising but insufficiently demonstrated | `jones2012topological`, `barrio2012topological` | Results; “Topology and symbolic tests still required” | RVR-003 | Controls, `a=0.140`, `a=0.145`, and `a=0.150` pass prospectively; EXP-121 narrows the sampled saddle bracket to `[0.145,0.149]`, while a continued curve and reinjection mechanism remain open |
