...
| Two/three extrema oscillation was promising but insufficiently demonstrated | `jones2012topological`, `barrio2012topological` | Results; “Topology and symbolic tests still required” | RVR-003 | Local attracting and saddle controls pass, including fixed-horizon independent PIM; continued curve and horizon stability open |
