...
| Two/three extrema oscillation was promising but insufficiently demonstrated | `jones2012topological`, `barrio2012topological` | Results; “Topology and symbolic tests still required” | RVR-003 | Controls, `a=0.140`, `a=0.145`, `a=0.147`, and `a=0.150` pass prospectively; blind EXP-122 narrows the sampled saddle bracket to `[0.147,0.149]`, while a continued curve and reinjection mechanism remain open |
