...
| Two/three extrema oscillation was promising but insufficiently demonstrated | `jones2012topological`, `barrio2012topological` | Results; “Topology and symbolic tests still required” | RVR-003 | Controls, one held-out saddle, and `a=0.150` resolution convergence pass; EXP-120 closes `a=0.145` sample scarcity and EXP-121 freezes its control-qualified coverage-censor successor; the continued curve remains open |
