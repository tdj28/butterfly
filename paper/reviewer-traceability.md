...
| The tool was not exploited or generalized | all core sources as context | Results; discussion | RVR-007 | Rössler computation now includes a dense 41-point period-6 flip curve and an identity-safe 124-point period-12 child-sheet patch with 31 square-root fits and independent solver controls; global endpoints, TBA comparison, and a cross-flow test remain open |
