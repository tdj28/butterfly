...
| The tool was not exploited or generalized | all core sources as context | Results; discussion | RVR-007 | Rössler computation now includes a dense 41-point period-6 flip curve, three independently qualified period-12 children, and replicated local square-root/multiplier/attraction tests; a true two-parameter child surface and cross-flow test remain open |
