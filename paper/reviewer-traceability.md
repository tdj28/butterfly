...
| Two/three extrema oscillation was promising but insufficiently demonstrated | `jones2012topological`, `barrio2012topological` | Results; “Topology and symbolic tests still required” | RVR-003 | Controls, one held-out saddle, and new-data `a=0.150` resolution convergence pass; `a=0.145` support and continued curve remain open |
