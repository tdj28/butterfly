...
| --- | --- | --- |
| [EXP-522 PNG](EXP-522-nonlinear-contact-refinement.png), [SVG](EXP-522-nonlinear-contact-refinement.svg), [PDF](EXP-522-nonlinear-contact-refinement.pdf) | [Complete new refinement audit](../experiments/receipts/EXP-522-nonlinear-contact-refinement-result.json) | [All variants, both references, hashes](EXP-522-nonlinear-contact-refinement.receipt.json), [hashed index](EXP-522-nonlinear-contact-refinement.index.json) |
