...
| CLM-003 | That parameter pair is a homoclinic point, and is the unique such point on the stated transition segment. | The original mechanism is strongly numerically qualified at a revised coordinate; the printed coordinate and uniqueness are not. Independent 16-arc DOP853 and 32-arc Radau roots plus three-radius persistence place the fixed-`c=10.3084` connection near `a=0.182643608174`, `0.00284361` above Jones's printed `a`. Natural continuation and eight qualified pseudo-arclength points reach `(a,c)=(0.1798174978857,10.3170814887419)`, only `1.74979e-5` above the historical fixed-`a` section, with stable local projections near `c=10.31713524`. EXP-369--372 preserve wrong-side, boundary-wall, and projected dense-conditioning failures; the last is unchanged after widening the nuisance angle and has smallest Jacobian singular value `2.70e-10`. These diagnose the formulation rather than falsify the qualified curve. The printed point, exact intersection, and uniqueness remain open. | Analytic eigenspaces; nonlinear stable branches; common-sphere matching; corrected single and multiple shooting; DOP853/Radau and 16/32-arc agreement; three-radius persistence; two qualified natural steps; eight qualified chained pseudo-arclength points through 256 arcs; preserved wrong-side and conditioning failures with source-centered guards. No historical-path intersection, computer-assisted proof, or uniqueness domain yet. | Use sparse/block collocation or a block-aware trust-region solve to bracket exact `a=0.1798`, qualify the section root, then audit all roots on a declared segment before any bounded uniqueness statement. |
