...
| CLM-015 | The topology-change/TBA curve remains well defined inside regular shrimp windows through nonattracting chaotic saddles. | Barrio-Blesa-Serrano result, verified as a claim of the local PRL; not a Jones result | Absent | Reproduce chaotic saddles with the sprinkler method or a stronger saddle-computation method and compare their return-map topology with nearby attractors |
