...
| CLM-019 | Stable period-12 and period-3 attractors coexist at `(a,b,c)=(0.245,0.2,5.75)` in the expanded high-`a` atlas. | Newly reproduced numerical finding: distinct periods persist through transient 19,200, both cycles pass closure/Floquet stability gates, and a `21 x 21` declared basin plane resolves 282 period-12 and 159 period-3 seeds | EXP-015 through EXP-017 | Measure basin-boundary scaling; recover both cycles by shooting/collocation; continue both families and their bifurcation boundaries; independently reproduce and interval-validate selected orbit data |
