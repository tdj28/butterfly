...
Latest CLM-003 checkpoint: fifty-five additional receipt-bound points,
EXP-418--472, raise the qualified curve total from 25 to 80 and the
pseudo-arclength total from 22 to 77.  Two adaptive doubled-step regimes and
their defect-aware reductions pass; forty subsequent conservative steps reach
`(a,c)=(0.1798592842285,10.3169531561905)` with `3.19975e-9` maximum defect and
`8.01873e-10` minimum singular value.  The outgoing arm is now reproduced
under 63 newly computed tangents after EXP-408.  EXP-403 remains the
