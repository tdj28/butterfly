...
| CLM-003 | That parameter pair is a homoclinic point, and is the unique such point on the stated transition segment. | Original claim; unestablished. EXP-155 shows that the Hopf-born period-1 family is not itself the proposed homoclinic orbit: at the hub it retains period `5.9935437090` and stays at least `10.0310033361` from the small equilibrium. EXP-329 then completes 96 unstable-eigenspace departures at the rounded coordinate and nominates no joint close/stable return. Receipt-bound EXP-331 resolves the closest coarse neighborhood with 257 angles: its closest return is `0.0104510073` from the equilibrium but remains `0.9992957` transverse to the stable eigendirection. These finite scans find recurrent transverse flybys, not a sampled homoclinic approach; finite coordinate precision and an unsearched parameter direction prevent rejection. | Analytic local eigenspaces, event-driven unstable departures, dense-output return minima, stable-direction alignment, hash-bound coarse/refined receipts, and preserved administrative failures. No stable/unstable equilibrium-manifold intersection or uniqueness domain yet. | Solve a two-variable stable/unstable manifold intersection in angle and parameter against the nonlinear local stable manifold; reproduce over shrinking matching spheres and an independent integrator; then continue all roots over a declared segment before making a bounded uniqueness statement. |
