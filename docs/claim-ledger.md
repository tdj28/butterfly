...
| CLM-003 | That parameter pair is a homoclinic point, and is the unique such point on the stated transition segment. | The original mechanism is strongly numerically qualified at a revised coordinate; the printed coordinate and uniqueness are not. Independent 16-arc DOP853 and 32-arc Radau roots plus three-radius persistence place the fixed-`c=10.3084` connection near `a=0.182643608174`, `0.00284361` above Jones's printed `a`. Qualified continuation points EXP-347 and EXP-350 have slopes `-0.325514` and `-0.325531`, prospectively pointing toward `a=0.1798` near `c=10.3171354`. However, fixed-`c` corrections EXP-354--357 stall at defect `3.76e-6` near `a=0.17981749`, while direct fixed-`a` solves EXP-351 and EXP-358 return to the same `~2.10e-4` stable-end floor near `c=10.317127`. The historical-path intersection remains unqualified; a fold/termination and singular endpoint conditioning are both live. | Analytic eigenspaces; nonlinear stable branches; common-sphere matching; corrected single and multiple shooting; DOP853/Radau and 16/32-arc agreement; three-radius persistence; two qualified local continuation points; preserved direct-intersection failures with source-centered node guards. No historical-path intersection, computer-assisted proof, or uniqueness domain yet. | Implement pseudo-arclength or collocation continuation with an explicit gauge to resolve the fold/conditioning ambiguity, then audit all roots on a declared segment before any bounded uniqueness statement. |
