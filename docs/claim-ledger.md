...
| CLM-003 | That parameter pair is a homoclinic point, and is the unique such point on the stated transition segment. | The original mechanism is strongly numerically qualified at a revised coordinate; the printed coordinate and uniqueness are not. Independent 16-arc DOP853 and 32-arc Radau roots plus three-radius persistence place the fixed-`c=10.3084` connection near `a=0.182643608174`, `0.00284361` above Jones's printed `a`. Natural continuation and eight qualified pseudo-arclength points reach `(a,c)=(0.1798174978857,10.3170814887419)`, only `1.74979e-5` above the historical fixed-`a` section, with stable local projections near `c=10.31713524`. EXP-369--377 preserve wrong-side, boundary-wall, projected-conditioning, stationary trust-region, and non-descent Newton failures. EXP-382 additionally rejects standard unconstrained collocation even as a zero-step positive control. These diagnose the formulations rather than falsify the qualified curve. The printed point, exact intersection, and uniqueness remain open. | Analytic eigenspaces; nonlinear stable branches; common-sphere matching; corrected single and multiple shooting; DOP853/Radau and 16/32-arc agreement; three-radius persistence; two qualified natural steps; eight qualified chained pseudo-arclength points through 256 arcs; preserved wrong-side and conditioning failures with source-centered guards. No historical-path intersection, computer-assisted proof, or uniqueness domain yet. | Retain bounded analytic-variational multiple shooting and freeze a weak full-state arclength plane whose `(a,c)` secant remains dominant; require a zero-step positive control before another forward crossing attempt, then audit all roots on a declared segment before any bounded uniqueness statement. |
