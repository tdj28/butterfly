...
| CLM-019 | Stable period-12 and period-3 attractors coexist at `(a,b,c)=(0.245,0.2,5.75)` in the expanded high-`a` atlas. | Newly reproduced numerical finding: distinct periods persist through transient 19,200 and both cycles pass closure/Floquet stability gates | EXP-015 and EXP-016 | Map a declared basin cross-section; recover both cycles by shooting/collocation; continue both families and their bifurcation boundaries; independently reproduce and interval-validate selected orbit data |
