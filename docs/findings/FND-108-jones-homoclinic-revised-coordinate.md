...
## Signed-arclength resolution through EXP-462
...
The qualified curve now contains 70 roots, including 67 pseudo-arclength
points.  Its outgoing arm is reproduced under 53 newly computed tangents after
...
EXP-448--462 add fifteen further conservative steps without changing any
numerical or acceptance setting. EXP-462 reaches
...
unchanged-gate chain now contains 70 qualified roots. EXP-403 remains the
...
Evidence: EXP-341 through EXP-462, including preserved negative results and
