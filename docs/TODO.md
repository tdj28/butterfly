...
- [ ] **P2-002 — Global bifurcations.** Homoclinic/heteroclinic boundary-value
  ...
  excluded on a declared branch segment. EXP-361 passes the next same-gauge
  ...
  the nineteenth point. EXP-412 passes the next identical-gate step and adds
  ...
  EXP-427 repeats the doubled step and adds the thirty-fifth point. The
  receipt-bound figure, manuscript, claim ledger, and finding record are
  ...
  receipt-bound 55-point figure and manuscript checkpoint. Both artifacts are
  regenerated, hash-bound, and visually inspected. EXP-448 passes and adds the
  ...
  receipt-bound 60-point figure and manuscript checkpoint. Both artifacts are
  ...
  passes and adds the sixty-fourth point. EXP-457 passes and adds the
  ...
  sixty-ninth point. EXP-462 passes and adds the seventieth point. The
  receipt-bound 70-point figure and 55-page manuscript are regenerated,
  hash-bound, and visually inspected. EXP-463 passes and adds the seventy-first
  point. EXP-464 passes and adds the seventy-second point. EXP-465 is
  ...
  receipts. It passes and adds the seventy-fifth point, triggering the
  receipt-bound figure/manuscript refresh. EXP-468 is prospectively frozen
  from the exact EXP-466/467 receipts; execute it without enlarging after the
  checkpoint artifacts are verified while conditioning remains below twice
  its floor.
