...
| EXP-481 replay and joint decisions (2026-09-06) | End-to-end synthetic CPU control passed | [Replay update and receipt](../updates/2026-09-06-exp481-replay-decisions.md); 33 new tests; 2,048 seeds in both profiles | All five fit variants and 200 bootstraps, but synthetic circle/short windows. No target numerical qualification, word verification, remote transfer or paid compute. |
| EXP-481 seed/batch plan and scalar-map analysis (2026-09-06) | Smoke-tested locally, synthetic maps only | [Sampling update and receipts](../updates/2026-09-06-exp481-sampling-design.md); 25 new tests | Explicit synthetic CLI only; proposal remains unreviewed and execution-disabled. No Rössler sampling, joint critical-membership result, remote transfer or paid compute. |
| EXP-481 paired-section durable recording (2026-09-06) | Smoke-tested locally; synthetic fields only | [Journal update and receipts](../updates/2026-09-06-exp481-durable-recording.md); 13 journal tests including actual child-process SIGKILL | Opt-in callback/benchmark flag; no target runner, remote transfer or resume. An incomplete or corrupt journal cannot certify completion. Does not verify Jones words. |
