...
EXP-518 is merged; EXP-519 is frozen and tested, with execution blocked before
target access by its initial disk reserve. A narrow operational amendment is
awaiting human approval; no scientific threshold has changed.
