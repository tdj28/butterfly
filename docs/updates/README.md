...
- [`2026-08-25-exp342-382-homoclinic-curve.md`](2026-08-25-exp342-382-homoclinic-curve.md)
  — eighteen qualified multiple-shooting roots approach within `1.75e-5` in
  `a` of Jones's historical section, resolve the first local `a` minimum, and
  continue onto its conditioned outgoing branch; the exact intersection and
  uniqueness stay open.
